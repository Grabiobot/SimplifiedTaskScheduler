namespace SimplifiedTaskScheduler.GUI
{
    partial class FormTaskData
    {
        ...
        private void InitializeComponent()
        {
            ...
            // tbpCommand
            // 
            this.tbpCommand.Controls.Add(this.nudSeconds);
            this.tbpCommand.Controls.Add(this.lblSeconds);
            this.tbpCommand.Controls.Add(this.nudMinutes);
            this.tbpCommand.Controls.Add(this.lblMinutes);
            this.tbpCommand.Controls.Add(this.nudHours);
            this.tbpCommand.Controls.Add(this.label2);
            this.tbpCommand.Controls.Add(this.lblHours);
